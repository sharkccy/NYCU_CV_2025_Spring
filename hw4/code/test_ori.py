...
from utils.dataset_utils import DenoiseTestDataset, DerainDehazeDataset, DerainDesnowDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, default='test/degraded', help='path to test directory containing degraded/')
    ...
    parser.add_argument('--output_path', type=str, default='pred.npz', help='path to save pred.npz')
